package com.Do2.android.exception;
...
import com.Do2.android.utils.ZHAppUtil;
 ...
 */
public class ZHCrashHandler implements UncaughtExceptionHandler {
    /** Debug Log Tag */
    ...
    public static void init(Context ctx, String toastMsg) {
        ZHCrashHandler crashHandler = getInstance();
        if(null != toastMsg){
...
//        final String msg = ex.getLocalizedMessage();
        ...
        Logger.e(TAG, "ABCrashHandler,deviceInfos: \n" + ZHAppUtil.collectDeviceInfoStr(mContext), ex);
        return true;
    }
